...
- search queries
  ...
  One you want prawns, another one chicken salad, and the trird wants some feta.
...
** TODO implement facets quickly?                                  :noexport:
...
- TODO write about [[https://doc.rust-lang.org/rust-by-example/trait/derive.html][derive]] debug/serialize
  ...
  TODO move this to enhancing tantivy??
...
- cargo: *very* easy to change dependency to local
  ...
  TODO it's not the same verions of Tantivy that's in master and it's a great thing!
  ...
  - or, github: ~cargo install --git https://github.com/karlicoss/tantivy-cli --branch serve-snippets~
...
- [[https://github.com/tantivy-search/tantivy-py][tantivy-py]]: surprisingly simple integration
  ...
  - just ~pip install .~ thanks to TODO cargo-setuptools?
    #+BEGIN_NOTES
